...
All files can be found in one of my github repositories: [https://github.com/RianneSchouten/workshops/tree/master/WomenInTechnology](https://github.com/RianneSchouten/workshops/tree/master/WomenInTechnology). Go to the repository and download the files to your local computer. The folder contains 3 important files:
