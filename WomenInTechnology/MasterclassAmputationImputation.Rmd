...
All files can be found in one of my github repositories: [https://github.com/RianneSchouten/workshops/tree/master/WomenInTechnology](https://github.com/RianneSchouten/workshops/tree/master/WomenInTechnology). To download the files, go to [https://minhaskamal.github.io/DownGit/#/home](https://minhaskamal.github.io/DownGit/#/home) and paste the link of the repository. Then click the button 'Download'. 
...
3. The R code is also saved in a .R file. Open this file with RStudio and run lines by pressing CTRL + ENTER. 
